...
function submit() {
  emit('submit', { type: 'LIVE', slug: slug.value, description: description.value, duration: duration.value })
  reset()
}
function reset() {
...
registerModalEsc(() => props.show, () => emit('update:show', false), 'LiveModal')
