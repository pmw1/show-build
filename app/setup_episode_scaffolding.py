...
def setup_episode_scaffolding():
    ...
    try:
        ...
        db.execute(text("""
            INSERT INTO blueprint_templates (name, description, template_type, is_active, is_default, template_metadata)
            VALUES 
                ('Sunday Show', 'Standard weekly Sunday show format with full rundown structure', 'episode', true, true, '{"type": "sunday_show", "duration": "01:00:00", "omnystudio_program_id": "6960f124-9e8a-4716-a88c-acfe00399fd7"}'),
                ('Sunday Live', 'Live Sunday show format with streaming optimizations', 'episode', true, false, '{"type": "sunday_live", "duration": "01:30:00", "streaming": true}'),
                ('Generic Live', 'General purpose live show format', 'episode', true, false, '{"type": "generic_live", "duration": "01:00:00", "streaming": true}')
