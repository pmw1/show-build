#!/usr/bin/env python3
"""Render quote 096: keep-family-safe"""
...
BOX_HEIGHT = int(CANVAS_HEIGHT * 0.80)
BOX_OPACITY = 217
BOX_Y = int((CANVAS_HEIGHT - BOX_HEIGHT) / 2)
