    ...
    try:
        ...
        for ep in db_episodes:
            ...
            episodes.append({
                ...
                "description_model": getattr(ep, 'description_model', None) or "",
                "short_description": getattr(ep, 'short_description', None) or "",
                "short_description_model": getattr(ep, 'short_description_model', None) or "",
