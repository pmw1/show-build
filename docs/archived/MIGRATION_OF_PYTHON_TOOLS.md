...
- Celery + Redis handles all async job coordination (MQTT removed)
...
- Celery-based job coordination (MQTT removed)
...
- **Establish background job system** with Celery + Redis for new implementations
